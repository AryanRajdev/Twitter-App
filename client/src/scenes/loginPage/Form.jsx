...
const Form = () => {
 ...
 const register = async (values, onSubmitProps) => {
  ...
  // Append actual file correctly
  if (values.picture) {
    formData.append("picture", values.picture); // ✅ matches upload.single("picture")
    formData.append("picturePath", values.picture.name); // ✅ fine
  }
...
const login = async (values, onSubmitProps) => {
    ...
    console.log("Login API Response:", loggedIn);
    onSubmitProps.resetForm();
